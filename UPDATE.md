...
**TinyTag loggers:** Drop new `.xlsx` files into `data/house5/` or `data/schoolteacher/` (Schoolteacher's House).
...
data/
  ...
  schoolteacher/                         ← TinyTag .xlsx files (Schoolteacher's House loggers)
